...
### C2 Setup
API key creation and endpoint configuration moved from the setup wizard to the dashboard UI. Create, rotate, and manage C2 access without re-running the installer.
...
### Startup Detection
C2-installed systems authenticate and log straight in. Manual installs redirect to /setup for first-time configuration.
