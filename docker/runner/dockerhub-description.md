MeshDash R3.1.1 — Official Docker Runner
...
⚠️ R3.1 Breaking Change: Port changed from 8000 to 8181
...
• Where is the dashboard? R3.1+ runs on port 8181 by default. Access via http://<host-ip>:8181
